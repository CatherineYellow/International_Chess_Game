...
public class BishopChessComponent extends ChessComponent{
    ...
    public BishopChessComponent(ChessboardPoint chessboardPoint, ChessColor black, char b) {
        super(chessboardPoint, black, b);
    }
    ...
    public void loadResource() throws IOException {
        if (BISHOP_WHITE == null) {
            BISHOP_WHITE = ImageIO.read(new File("./Chess/src/main/java/images/bishop-white.png"));
        }

        if (BISHOP_BLACK== null) {
            BISHOP_BLACK = ImageIO.read(new File("./Chess/src/main/java/images/bishop-black.png"));
        }
    }
