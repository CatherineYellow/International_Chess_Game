...
public class RookChessComponent extends ChessComponent {
    ...
    public RookChessComponent(ChessboardPoint chessboardPoint, ChessColor chessColor, char r) {
        super(chessboardPoint, chessColor, r);
    }
    ...
    public void loadResource() throws IOException {
        if (ROOK_WHITE == null) {
            ROOK_WHITE = ImageIO.read(new File("./Chess/src/main/java/images/rook-white.png"));
        }

        if (ROOK_BLACK == null) {
            ROOK_BLACK = ImageIO.read(new File("./Chess/src/main/java/images/rook-black.png"));
        }
    }
